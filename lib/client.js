...
var pasteImageContainer = document.getElementById("pasteImage");
// Varible - store
...
function pasteImage(url) {
    ...
    if (!pasteImageContainer) {
        ...
        (_a = pasteImageContainer.querySelector("img")) === null || _a === void 0 ? void 0 : _a.setAttribute("src", url);
        pasteImageContainer.querySelector("span").onclick = function (e) {
            e.stopPropagation();
            onSend({ userName: userName, type: "image", message: url });
            pasteImageContainer.style.display = "none";
        };

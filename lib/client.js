    ...
    try {
        ...
        reader.onload = function (e) {
            return __awaiter(this, void 0, void 0, function () {
                var text, fileList, imgSrc, _a, prefix, data;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            if (!(fileSize(text) > mb(1))) return [3 /*break*/, 2];
                            fileList = [base64ToFile(text)];
                            return [4 /*yield*/, compress.compress(fileList, { size: 1, quality: 0.1 })];
                        case 1:
                            imgSrc = _b.sent();
